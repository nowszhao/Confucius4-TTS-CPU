...
def main(args: argparse.Namespace) -> None:
    ...
    data_module = T2SDataModule(
        ...
        max_text_seq_len=model_cfg.get("max_text_seq_lens", 600),
        max_semantic_seq_len=model_cfg.get("max_semantic_seq_lens", 750),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-t", "--training-config", type=str, default=None, help="Optional training config override")
